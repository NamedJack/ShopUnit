...
import com.wongxd.shopunit.databinding.AtyShopInfoBinding;
...
public class ShopInfoActivity extends BaseBindingActivity<AtyShopInfoBinding> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.aty_shop_info);
        thisActivity = this;
        ...
        bindingView.btnChange.setOnClickListener(v -> doChange());
    ...
    private void doChange() {
        ...
        WNetUtil.StringCallBack(builder,
                UrlConf.UpdaeShopInfoUrl, thisActivity, "修改店铺信息中", true,
