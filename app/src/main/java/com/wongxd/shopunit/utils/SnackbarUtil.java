...
//    }
    ...
    /**
     * 长显示Snackbar，可选预设类型,从顶部弹出
     *
     * @param view    getDecorView
     * @param message
     * @param type
     * @return
     */
...
//        ViewGroup vg = (ViewGroup) view.getRootView();
        CoordinatorLayout cl = new CoordinatorLayout(view.getContext());
//     WindowManager.LayoutParams lp = new WindowManager.LayoutParams();
//        lp.height = WindowManager.LayoutParams.WRAP_CONTENT;
//        lp.width = WindowManager.LayoutParams.MATCH_PARENT;
//        vg.addView(cl, lp);

        RelativeLayout relativeLayout = (RelativeLayout) view.getRootView().findViewById(R.id.container);
        RelativeLayout.LayoutParams lp = new RelativeLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT,
                ViewGroup.LayoutParams.WRAP_CONTENT+150);
        relativeLayout.addView(cl, lp);
