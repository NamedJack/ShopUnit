...
public class TU {
    ...
    public static void cT(String s, boolean isGreen) {
        ...
        if (toast == null) {
            ...
            if (isGreen) {
                v.setBackground(c.getResources().getDrawable(R.drawable.toast_background_green));
            }
            toast.setView(v);
            ...
            if (isGreen) {
                toast.getView().setBackground(c.getResources().getDrawable(R.drawable.toast_background_green));
            }
    ...
    public static void cT(int res,boolean isGreen) {
        cT(c.getString(res),isGreen);
    }
